...
class WebglLineRoll {
    ...
    lastDataY;
    colorLocation;
    constructor(wglp, rollBufferSize) {
        //super();
        this.wglp = wglp;
        this.gl = wglp.gl;
        const gl = this.gl;
        ...
        this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array((this.rollBufferSize * 2 + 4) * 3), this.gl.DYNAMIC_DRAW);
    ...
    addPoint(y) {
        ...
        gl.bufferSubData(gl.ARRAY_BUFFER, (this.dataIndex + bfsize) * 2 * 4, new Float32Array([this.dataX, y + 0.2]));
        gl.bufferSubData(gl.ARRAY_BUFFER, (this.dataIndex + bfsize * 2) * 2 * 4, new Float32Array([this.dataX, y - 0.1]));
        ...
        if (this.dataIndex === 0 && this.lastDataX[0] !== 0) {
            gl.bufferSubData(gl.ARRAY_BUFFER, this.rollBufferSize * 2 * 4, new Float32Array([this.lastDataX[0], this.lastDataY[0], this.dataX, y]));
            gl.bufferSubData(gl.ARRAY_BUFFER, (this.rollBufferSize + bfsize) * 2 * 4, new Float32Array([this.lastDataX[1], this.lastDataY[1], this.dataX, y + 0.2]));
            gl.bufferSubData(gl.ARRAY_BUFFER, (this.rollBufferSize + bfsize * 2) * 2 * 4, new Float32Array([this.lastDataX[2], this.lastDataY[2], this.dataX, y - 0.1]));
        }
